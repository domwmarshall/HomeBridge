...
export function HouseholdSetupScreen() {
  ...
  const submit = async () => {
    if (
      !displayName.trim() ||
      (mode === "create" && (!householdName.trim() || !childName.trim())) ||
      (mode === "join" && !inviteCode.trim())
    ) {
      Alert.alert(
    ...
    >
      ...
      >
        ...
        <Text style={styles.body}>
          One parent creates the household. The other joins with a private
        ...
        <Card>
          <View style={styles.switcher}>
            <Pressable
              ...
              style={[styles.switch, mode === "create" && styles.switchActive]}
            >
              <Text
                style={[
                  styles.switchText,
            ...
            <Pressable
              ...
              style={[styles.switch, mode === "join" && styles.switchActive]}
            >
              <Text
                style={[
                  styles.switchText,
                  mode === "join" && styles.switchTextActive,
                ]}
              >
                Join with code
              </Text>
          ...
          <View style={styles.parentChoices}>
            {(["Dad", "Mum"] as const).map((label) => (
              <Pressable
                key={label}
                onPress={() => setParentLabel(label)}
                style={[
                  styles.parentChoice,
                  parentLabel === label && styles.parentChoiceActive,
                ]}
              >
                <Text
                  style={[
                    styles.parentText,
                    parentLabel === label && styles.parentTextActive,
                  ]}
                >
                  {label}
                </Text>
